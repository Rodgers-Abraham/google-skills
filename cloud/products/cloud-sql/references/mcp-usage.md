...
Cloud SQL is supported by a [remote Model Context Protocol (MCP) server](https://docs.cloud.google.com/sql/docs/mysql/use-cloudsql-mcp) that
allows agents to manage database instances and execute SQL queries. As an
alternative to connecting to a remote MCP server, you can use the MCP Toolbox
to execute tools locally for:
...
To connect to the Cloud SQL MCP server, see [Setting up Cloud SQL MCP](https://docs.cloud.google.com/sql/docs/mysql/use-cloudsql-mcp).
